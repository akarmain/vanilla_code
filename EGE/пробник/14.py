...
def main():
    ...
    # 3 * 22^6 + 4 * 22^5 + 2 * 22^4 + 5 * 22^3 + 6 * 22^2 + x * 22^1 + 4 * 22^0.
    # Число 72847y3 (в основе 22):
    # 7 * 22^6 + 2 * 22^5 + 8 * 22^4 + 4 * 22^3 + 7 * 22^2 + y * 22^1 + 3 * 22^0.
    ...
    # Расширенным алгоритмом Евклида получаем: 22*108 ≡ 1 (mod 125)
